...
fn real_main() -> i32 {
	...
	// This needed to be done early on (like logs_rx/tx) because it is dropped
	// when it goes out of scope and the rx errors. Also used Box::leak to
	// ensure it's never dropped.
